...
export const DEALS: Deal[] = [
  {
    ...
    badge: '10% Off — Exclusive',
    description: 'Investor-ready pitch deck built with you. Narrative, design, financial summary. Trusted by 200+ founders.',
    link: 'https://www.foundterra.com/pitch-deck?utm_source=deals-page&utm_medium=card&discount=DEALS10',
    category: 'foundterra',
    source: 'direct',
    discountCode: 'DEALS10',
  },
  {
    ...
    link: 'https://www.foundterra.com/pitch-review?utm_source=deals-page&utm_medium=card&offer=review100',
    category: 'foundterra',
    source: 'direct',
    originalPrice: 250,
    salePrice: 100,
