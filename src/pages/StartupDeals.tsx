    ...
    <div className="min-h-screen" style={{ fontFamily: "var(--font-body)" }}>
      ...
      <main className="pt-24">
        <section className="container-max py-16 text-center">
          ...
          <h1 style={{ fontFamily: "var(--font-body)", fontWeight: 700 }} className="mx-auto mb-4 max-w-4xl text-5xl text-[#EEEEF8]">$600,000+ in free tools & credits for your startup</h1>
          ...
          <div className="flex justify-center gap-3">
            ...
            <a href="/paid-consultation" className="rounded-md border border-[#34345a] px-5 py-3 text-sm font-semibold text-[#d8d8f4]">Get My Deck Reviewed — $100</a>
          </div>
        </section>
        ...
        <section id="deals-start" className={sectionClass}>
          <h2 style={{ fontFamily: "var(--font-body)", fontWeight: 700 }} className="mb-2 text-3xl text-[#EEEEF8]">$760K+ in Cloud Credits</h2>
        ...
        <section className={sectionClass}>
          <h2 style={{ fontFamily: "var(--font-body)", fontWeight: 700 }} className="mb-2 text-3xl text-[#EEEEF8]">Premium Tools at Founder Prices</h2>
        ...
        <section className={sectionClass}>
          <h2 style={{ fontFamily: "var(--font-body)", fontWeight: 700 }} className="mb-2 text-3xl text-[#EEEEF8]">Pay Once. Own It Forever.</h2>
        ...
        <section className="container-max pb-20 pt-8 text-center">
          <h2 style={{ fontFamily: "var(--font-body)", fontWeight: 700 }} className="mb-3 text-4xl text-[#EEEEF8]">Your stack is ready. Now build the deck.</h2>
