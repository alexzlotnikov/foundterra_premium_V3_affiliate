      ...
      <div className="container-max">
        <div className="flex items-center justify-between h-16 sm:h-20 gap-2 sm:gap-4">
          ...
          <nav className={`hidden lg:flex items-center gap-5 xl:gap-7 ${language === "he" ? "space-x-reverse" : ""}`} dir={language === "he" ? "rtl" : "ltr"}>
            <button onClick={() => handleNavigation("/", "services")} className="text-muted-foreground hover:text-foreground transition-colors responsive-text-xs whitespace-nowrap px-1 bg-transparent border-none cursor-pointer tracking-[0.06em]">{content.navigation.services}</button>
