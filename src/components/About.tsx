...
const About = () => {
  ...
  const t = isHebrew
    ? {
        ...
        paths: [
          ["Diagnose", "Pitch Deck Diagnostic", "$100", "פידבק מפורט על המצגת, שיחת ייעוץ של שעה, ציון מוכנות והמלצת המשך.", "/pay/pitch-deck-review", "Book Diagnostic", "hero"],
          ["Iterate", "Monthly Fundraising Support", "$300–$1,000/mo", "פידבק שוטף בזמן ההכנה, ההשקה וניהול הגיוס.", "#plans", "View Plans", "outline"],
          ["Build", "Done-For-You Services", "From $1,500", "צריך בנייה מקצועית של מצגת, מודל, דאטה רום או מחקר שוק?", "#services", "View Services", "outline"],
        ] as const,
      }
    : {
